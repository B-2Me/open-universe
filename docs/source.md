...
* **The Architecture of Perception:** Early sensory processing across diverse species converges on optimized motifs (broad receptors, single receptor expression, and glomerular convergence) to maximize mutual information between environmental stimuli and internal representation.
* **Reference:** [Convergent Motifs of Early Olfactory Processing are Recapitulated by Layer-Wise Efficient Coding (PNAS, 2026)](/library/del-castillo-et-al-2026-convergent-motifs-of-early-olfactory-processing-are-recapitulated-by-layer-wise-efficient-coding.pdf).
