...
* **Status:** Planned
* **Focus:** Decoding grammar as structural alignment. A look at how language structures and relational pronouns help keep our distributed local experiences synchronized without requiring a central server.
